...
<head>
    ...
    <link rel="stylesheet" href="/DulceAlHornoWebPedidos/v4 (mejorada)/assets/css/styles-login-registro.css">
...
<body>
    ...
    <div id="modal" class="modal" style="display: none;">
        <div class="modal-contenido">
            ...
            <form id="formLogin" class="formulario" action="/DulceAlHornoWebPedidos/v4 (mejorada)/users/login.php" method="POST">
            ...
            <form id="formRegistro" class="formulario oculto" action="/DulceAlHornoWebPedidos/v4 (mejorada)/users/registro.php" method="POST">
                <h2>Registrarse</h2>
